...
// This service worker creates a vector for UXSS by violating security requirement 3.1 (not *correctly* authenticating messages coming from a content script).
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    if (sender.url.startsWith("https://www.google.com")) { // <== VULNERABILITY LIES HERE! Sender of message is not *properly* checked/authenticated!
