...
//   rather in content.js, which (unlike in "vuln01_mv3_non_authenticated") now acts as a proxy for the pure(!!!) web attacker:
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  //   => requesting content script is relaying a malicious request that it got from a malicious website via postMessage()
